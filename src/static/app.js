document.addEventListener("DOMContentLoaded", () => {
    ...
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        const participantsHtml = details.participants.length
          ? details.participants.map(p => `<li class="participant-item">${p} <button class="participant-delete" data-email="${encodeURIComponent(p)}" title="Unregister">✖</button></li>`).join("")
  ...
  // Remove participant handler (delegated)
